# -*- coding: utf-8 -*-
"""
Created on Thu Mar 10 08:52:28 2022
...
Use_Both_Inputs=True # If you like to use both images and second property like h2,temp etc
...
remove_correlated=True #Take out correlated terms
...
import pandas as pd
df=pd.read_csv('G_avg_crack_calc.csv')  # Change da_dn here to get another property
...
if Extra_Input:
    df=pd.read_csv('h2_full.csv')  # Change da_dn here to get another property
...
#      number=int(nameonly)
      ...
      q=df.loc[df['Serial'] == int(number)]['h2'] #Changed number to INT because of new h2_full file 
      X_2[i]=q.values[0]
